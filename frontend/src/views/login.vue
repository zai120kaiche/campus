<template>
  <el-container v-if="!isPhone" class="page_back page_this">
    ...
    <el-footer style="margin-bottom: 5%; margin-left: 10%">
      <el-row>
        <el-col :span="6">
          <el-row>
            <el-col :span="12" v-on:click="serviceShow = true">智能客服 | <el-icon style="padding-top: 5%"><User /></el-icon></el-col>
  ...
  <el-container v-else class="page_back page_this">
    <el-header style="margin-top: 5%; margin-left: 2%">
      <el-row>

        <el-col :span="6"><el-image style="width: 80%; height: 80%; z-index: 1; background-color: transparent" :src="require('../assets/images/logo.png')"
                                        :fit="'fill'"></el-image></el-col>

      </el-row>
    </el-header>
    <el-container style="margin-left: 2%; margin-right: 2%">
  ...
  <el-drawer v-if="!isPhone" v-model="userVisible" :direction="'rtl'">
    <template #header>
      <h4>用户协议</h4>
    </template>
    <template #default>
  ...
  <el-drawer v-if="!isPhone" v-model="dialogVisible" :direction="'rtl'">
    <template #header>
      <h4>免责声明</h4>
    </template>
    <template #default>
  ...
  <el-drawer v-if="!isPhone" v-model="secretVisible" :direction="'rtl'">
    <template #header>
      <h4>产品隐私政策</h4>
    </template>
    <template #default>
  ...
  <el-drawer v-if="isPhone" v-model="userVisible" size="88%" :direction="'btt'">
    <template #header>
      <h4>用户协议</h4>
    </template>
    <template #default>
  ...
  <el-drawer v-if="isPhone" v-model="dialogVisible" size="88%" :direction="'btt'">
    <template #header>
      <h4>免责声明</h4>
    </template>
    <template #default>
  ...
  <el-drawer v-if="isPhone" v-model="secretVisible" size="88%" :direction="'btt'">
    <template #header>
      <h4>产品隐私政策</h4>
    </template>
    <template #default>
